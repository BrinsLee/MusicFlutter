...
class Colors {
  ...
  static const Color _accentColor = Color(0xFFA0B8EA);
  ...
  static const Color _highlightColor = Color(0xFFA3A5EF);
  final Color _mainAccentColor = Color(0xFFF0F0F0);
  ...
  Color highlightColor(double opacity) {
    return _highlightColor.withOpacity(opacity);
  }
}
